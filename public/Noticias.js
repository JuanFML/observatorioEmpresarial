...
const breakingNews = [
    {
        ...
        image: "Imágenes/Mexico1.jpg",
        description: "Durango destaca en México por un preocupante aumento del 18% en economía informal, superando récords y generando alerta nacional.",
        url: "Noticia1.html"
    },
    {
        title: "Impacto de los aranceles al noreste mexicano",
        image: "Imágenes/aranceles.jpg",
        description: "Empresarios del noreste advierten afectaciones por aranceles de EE. UU. a exportaciones e inversiones clave en la región.",
        url: "Noticia2.html"
    },
    {
        title: "Empresarios del noreste alertan por riesgos globales",
        image: "Imágenes/Problema.jpg",
        description: "Líderes empresariales del noreste mexicano priorizan amenazas externas como aranceles, inflación y tensiones comerciales en sus estrategias.",
        url: "Noticia3.html"
    }
];
...
const newsData = [
    {
        ...
        category: "local",
        image: "Imágenes/Crisis agricola.jpg",
        date: "20-05-2025"
    },
    {
        id: 2,
        title: "Inversiones en infraestructura hídrica",  
        description: "Inversiones millonarias para infraestructura hídrica y tecnificación por parte del gobierno federal",
        category: "economia",
        image: "Imágenes/Infraestructura hidrica.jpg",
        date: "15-05-2025"
    },
    {
        id: 3,
    ...
    },
    {
        ...
        category: "local",
        image: "Imágenes/NearShore.jpg",
        date: "12-05-2025"
    },
    {
        id: 5,
        title: "Proyecciones económicas a la baja para 2025",
        description: "La Secretaría de Hacienda redujo en abril el rango estimado de crecimiento del PIB de entre 2.0% y 3.0% a entre 1.5% y 2.3%",
        category: "nacional",
        image: "Imágenes/Proyecciones baja.jpg",
        date: "10-05-2025"
    },
    {
        id: 6,
        title: "México busca reducir incertidumbre antes de la revisión del TMEC",
        description: "El secretario de Economía afirmó que México busca reducir la incertidumbre económica mediante un diálogo más cordial con Estados Unidos",
        category: "economia",
        image: "Imágenes/Acuerdo.jpg",
        date: "10-05-2025"
    },
...
document.addEventListener('DOMContentLoaded', async () => {
    ...
    let gnewsArticles = await fetchGNewsArticles('economía Coahuila', NUM_GNEWS_ARTICLES);
    // 2. Si hay menos de las necesarias, buscar noticias generales
    if (gnewsArticles.length < NUM_GNEWS_ARTICLES) {
        const fallbackArticles = await fetchGNewsArticles('economía México', NUM_GNEWS_ARTICLES);    
        // Añadir solo los que faltan (evita duplicados)
        const urlsYaIncluidas = new Set(gnewsArticles.map(article => article.url));
        const nuevosArticulos = fallbackArticles.filter(article => !urlsYaIncluidas.has(article.url));        
        gnewsArticles = gnewsArticles.concat(nuevosArticulos.slice(0, NUM_GNEWS_ARTICLES - gnewsArticles.length));
    }
    ...
    breakingNews.forEach((news, index) => {
      ...
      div.innerHTML = `
        <a href="${news.url || '#'}" target="_blank" style="text-decoration: none; color: inherit;">
            ...
            <img src="${news.image}" alt="${news.title}" class="carousel-thumbnail">
...
function displayNews(category) {
    ...
    filteredNews.forEach(news => {
        ...
        article.innerHTML = `
            <img src="${news.image}" alt="${news.title}" onclick="window.open('${news.url || '#'}', '_blank')" style="cursor:pointer">
...
const rssFeeds = [
    ...
    'https://api.allorigins.win/raw?url=' + encodeURIComponent('https://cdn.feedcontrol.net/10268/18374-UEuzIY9gDjDwH.xml')
...
function transformGNewsToNewsData(articles) {
    return articles.map(article => ({
        ...
        category: 'nacional',
        image: article.image || 'Imágenes/default.jpg',
